...
const PHPIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M7.35 8h1.75c1.38 0 2.1.61 2.1 1.76 0 1.19-.79 1.98-2.02 1.98h-.94L7.85 14H6.5L7.35 8zm.84 2.82h.65c.7 0 1.11-.37 1.11-1 0-.54-.35-.89-1.05-.89h-.59l-.12 1.89zM12.35 8h1.35l-.85 6h-1.35l.85-6zm5.98 0h1.35l-.32 2.24h1.97L21.65 8H23l-.85 6h-1.35l.35-2.48h-1.97L18.83 14h-1.35l.85-6z" />
  </svg>
)
...
const DockerIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M13.5 10.5h2v-2h-2v2zm-3 0h2v-2h-2v2zm-3 0h2v-2h-2v2zm-3 0h2v-2h-2v2zm9-3h2v-2h-2v2zm-3 0h2v-2h-2v2zm-3 0h2v-2h-2v2zm15 3.5c-.5-.7-1.5-1-2.5-1-.2 0-.4 0-.7.1-.3-.9-1-1.6-2-1.6H.8c-.5 0-.8.3-.8.8v7.2c0 .7.6 1.2 1.2 1.2h9.6c.8 0 1.4-.4 1.8-1 .3-.5.8-.9 1.4-1.1.8-.3 1.6-.4 2.5-.3.5.1.9.1 1.2.2h.1c.2 0 .4 0 .5.1.3 0 .5-.2.5-.4v-3.4c0-.3-.2-.6-.5-.8z" />
  </svg>
)

const DotNetIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M3.033 5.002h-.87c-.128 0-.231.107-.231.239v13.52c0 .132.103.239.231.239h.87c.128 0 .231-.107.231-.239V5.241c0-.132-.103-.239-.231-.239zM7.876 5.002h-.928c-.072 0-.137.034-.18.087L3.65 10.022l.001-4.781c0-.132-.103-.239-.231-.239h-.87c-.128 0-.231.107-.231.239v13.52c0 .132.103.239.231.239h.87c.128 0 .231-.107.231-.239v-4.78l3.118 4.932c.043.053.108.087.18.087h.928c.185 0 .296-.205.196-.361l-3.421-5.411 3.421-5.412c.1-.156-.011-.361-.196-.361zm5.39 13.996h5.301c.128 0 .231-.107.231-.239v-.87c0-.132-.103-.239-.231-.239h-4.17v-4.414h3.814c.128 0 .231-.107.231-.239v-.87c0-.132-.103-.239-.231-.239h-3.814V7.473h4.17c.128 0 .231-.107.231-.239v-.87c0-.132-.103-.239-.231-.239h-5.301c-.128 0-.231.107-.231.239v13.52c0 .132.103.239.231.239zm14.727-7.411V5.241c0-.132-.103-.239-.231-.239h-.87c-.128 0-.231.107-.231.239v6.346c0 1.548-.878 2.487-2.345 2.487-1.468 0-2.345-.939-2.345-2.487V5.241c0-.132-.103-.239-.231-.239h-.87c-.128 0-.231.107-.231.239v6.346c0 2.177 1.381 3.629 3.677 3.629s3.677-1.452 3.677-3.629z" />
  </svg>
)
